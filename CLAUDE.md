...
> Cập nhật: 2026-06-14 | Nguồn: Tài liệu chính thức Anthropic + kinh nghiệm thực tế
...
- `/help` — Hỏi trợ giúp
- `/model <name>` — Đổi model (fable-5, opus-4.8, sonnet-4.6, haiku-4.5)
...
> Cập nhật: 2026-06-14 | **11 dự án triển khai + 3 cơ hội kinh doanh**
